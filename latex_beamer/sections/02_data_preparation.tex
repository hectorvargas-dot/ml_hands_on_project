...
\small Sequential Feature Selection (Forward and Backward) was applied to Random Forest and XGBoost models, optimizing PR-AUC through 5-Fold Cross-Validation.
\end{block}
