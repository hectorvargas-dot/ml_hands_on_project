...
% ---------------------------------------------------------
% MONITORING INTERFACE ROUTING (FASTAPI)
% ---------------------------------------------------------
...
async def monitor_drift(reference_file: UploadFile, current_file: UploadFile, run_id: str):
...
async def monitor_target_drift(reference_file: UploadFile, current_file: UploadFile, target_column: str = "Exited"):
